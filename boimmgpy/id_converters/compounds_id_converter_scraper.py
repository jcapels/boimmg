...
class CompoundsIDConverterScraper:
    ...
    def __init__(self):
        self.url_db = "https://raw.githubusercontent.com/ModelSEED/ModelSEEDDatabase/master/Biochemistry/Aliases/Unique_ModelSEED_Compound_Aliases.txt"
    ...
    def __check_time(self):
        last_update_time = self.__database_config["time_model_seed_compounds_aliases"]
