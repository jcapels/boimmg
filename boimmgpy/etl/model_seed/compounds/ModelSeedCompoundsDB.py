...
from BOIMMGpy.ModelSEED.ModelSeedCompound import ModelSeedCompound
from BOIMMGpy.ModelSEED.ModelSeedCompoundsDBScraper import ModelSeedCompoundsDBScraper
from BOIMMGpy.Utilities import ChemoUtilities
        ...
        for compound in self.__compounds:
            ...
            if inchikey or smiles:
                ...
                if mol:
                    ...
                    try:
                        neutralized, _ = ChemoUtilities.NeutraliseCharges(canonical_smiles)

                        neutralized_not_isomer, _ = ChemoUtilities.NeutraliseCharges(canonical_smiles_not_isomer)
