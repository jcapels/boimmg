...
class SimpleCaseSolver(RepresentationProblemSolver):

    def __init__(self, model: Model, database_format: str, modelseed_compoundsdb=None):
        """
        Class constructor
        ...
        if not modelseed_compoundsdb:
            self.__modelseedCompoundsDb = ModelSeedCompoundsDB()
        else:
            self.__modelseedCompoundsDb = modelseed_compoundsdb
